...
const data = [
  {
    input: new Date('2022-10-30T09:30:00-07:00'),
    expected: [20221030, 930],
  },
  {
    input: new Date('2022-10-31T13:30:00-07:00'),
    expected: [20221031, 1330],
  },
  {
    input: new Date('2022-10-31T17:00:00-07:00'),
    expected: [20221031, 1700],
  },
  {
    input: new Date('2022-11-01T08:00:00-07:00'),
    expected: [20221101, 800],
  },
  {
    input: new Date('2022-11-01T16:30:00-07:00'),
